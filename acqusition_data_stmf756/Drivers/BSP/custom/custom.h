...
#define USER_BUTTON_EXTI_LINE              EXTI_LINE_5
#define H_EXTI_5			  hpb_exti[BUTTON_USER]
/**
 * @}
 */
 ...
 */
/**
 * @brief Definition for COM portx, connected to UART8
 */

#define BUS_UART8_INSTANCE UART8
#define BUS_UART8_RX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOE_CLK_DISABLE()
#define BUS_UART8_RX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOE_CLK_ENABLE()
#define BUS_UART8_RX_GPIO_PIN GPIO_PIN_0
#define BUS_UART8_RX_GPIO_PORT GPIOE
#define BUS_UART8_RX_GPIO_AF GPIO_AF8_UART8
#define BUS_UART8_TX_GPIO_PIN GPIO_PIN_1
#define BUS_UART8_TX_GPIO_PORT GPIOE
#define BUS_UART8_TX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOE_CLK_DISABLE()
#define BUS_UART8_TX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOE_CLK_ENABLE()
#define BUS_UART8_TX_GPIO_AF GPIO_AF8_UART8
...
#define COMn                             1U
#define COM1_UART                        UART8

#define COM_POLL_TIMEOUT                 1000
extern UART_HandleTypeDef hcom_uart[COMn];
#define  huart8 hcom_uart[COM1]
