...
static int32_t LSM6DSV16X_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    MotionCtx[IKS02A1_LSM6DSV16X_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[IKS02A1_LSM6DSV16X_0] = &lsm6dsv16x_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[IKS02A1_LSM6DSV16X_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&LSM6DSV16X_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & MOTION_GYRO) == MOTION_GYRO) && (cap.Gyro == 1U))
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS02A1_LSM6DSV16X_0][FunctionIndex[MOTION_GYRO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV16X_GYRO_Driver;

      if (MotionDrv[IKS02A1_LSM6DSV16X_0]->Init(MotionCompObj[IKS02A1_LSM6DSV16X_0]) != LSM6DSV16X_OK)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS02A1_LSM6DSV16X_0][FunctionIndex[MOTION_ACCELERO]] = (MOTION_SENSOR_FuncDrv_t *)(
...
static int32_t LSM6DSV16BX_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    MotionCtx[IKS02A1_LSM6DSV16BX_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[IKS02A1_LSM6DSV16BX_0] = &lsm6dsv16bx_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[IKS02A1_LSM6DSV16BX_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&LSM6DSV16BX_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & MOTION_GYRO) == MOTION_GYRO) && (cap.Gyro == 1U))
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS02A1_LSM6DSV16BX_0][FunctionIndex[MOTION_GYRO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV16BX_GYRO_Driver;

      if (MotionDrv[IKS02A1_LSM6DSV16BX_0]->Init(MotionCompObj[IKS02A1_LSM6DSV16BX_0]) != LSM6DSV16BX_OK)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS02A1_LSM6DSV16BX_0][FunctionIndex[MOTION_ACCELERO]] = (MOTION_SENSOR_FuncDrv_t *)(
